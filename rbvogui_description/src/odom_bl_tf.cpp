...
public:
    DynamicTfPublisher() : Node("dynamic_tf_publisher") {
        ...
        odom_sub_ = this->create_subscription<nav_msgs::msg::Odometry>(
            "/steering_controller/odometry", 10,
...
private:
    void odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg) {
        ...
        // creation and publishing of dynamic transformation
        geometry_msgs::msg::TransformStamped transform_stamped;
        transform_stamped.header.stamp = this->now();
        transform_stamped.header.frame_id = "odom";
        transform_stamped.child_frame_id = "robot_base_footprint";
        ...
        RCLCPP_DEBUG(this->get_logger(),
                     "Published transform: [frame: odom -> robot_base_footprint] [x: %.2f, y: %.2f, yaw: %.2f]",
                     x, y, yaw);
    }
